...
var FavoriteSolid = require('../Icon/icons/FavoriteSolid.js');
...
var Favorite = function Favorite(_ref) {
  var favorited = _ref.favorited,
      what = _ref.what,
      buttonProps = _objectWithoutProperties(_ref, ["favorited", "what"]);

  return React__default.createElement("button", _extends({
    "aria-label": "".concat(favorited ? 'Remove' : 'Save', " ").concat(what, " ").concat(favorited ? 'from' : 'to', " my favorites.")
  }, buttonProps, {
    "aria-pressed": favorited,
    className: cx('kds-Favorite', {
      'kds-Favorite--favorited': favorited
    }, buttonProps.className)
  }), React__default.createElement(FavoriteSolid.IconFavoriteSolid, {
    size: "m",
...
var Favorite$1 = React__default.memo(Favorite);

exports.default = Favorite$1;
