...
var BreadcrumbLink = function BreadcrumbLink(_ref) {
  var title = _ref.title,
      ...
      UserLink = _ref.component,
      props = _objectWithoutProperties(_ref, ["title", "url", "inverse", "withRouter", "component"]);

  return React__default.createElement("li", {
    className: "inline"
  }, UserLink ? React__default.createElement(UserLink, _extends({
    className: cx('kds-Link', 'mr-4', "kds-Link--inherit", {
      'kds-Link--inverse': inverse
    }, props.className),
    href: url
  }, props), title) : React__default.createElement(Link.default, _extends({
    inverse: inverse,
    className: "mr-4",
    href: url,
    withRouter: withRouter,
    noRouter: !withRouter
  }, props), title), React__default.createElement(CaretRight.IconCaretRight, {
...
//# sourceMappingURL=_BreadcrumbLink.js.map
