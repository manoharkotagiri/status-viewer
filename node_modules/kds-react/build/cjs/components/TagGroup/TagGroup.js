...
function (_Component) {
  ...
  function TagGroup(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "isNonMixedTagsKinds", function () {
      var childrenArr = React__default.Children.toArray(_this.props.children).filter(function (child) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderChildren", function () {
      var childrenArr = React__default.Children.toArray(_this.props.children);
