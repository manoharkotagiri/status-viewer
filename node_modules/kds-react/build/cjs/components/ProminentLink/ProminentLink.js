...
var RightArrow = require('../Icon/icons/RightArrow.js');
...
var ProminentLink = function ProminentLink(_ref) {
  var className = _ref.className,
      implied = _ref.implied,
      explicit = _ref.explicit,
      size = _ref.size,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ["className", "implied", "explicit", "size", "children"]);

  return React__default.createElement(Link.default, _extends({}, props, {
    className: cx('kds-ProminentLink', "kds-ProminentLink--".concat(sizeOpts.includes(size) ? size : 'l'), className),
    size: "manual"
  }), children, React__default.createElement(RightArrow.IconRightArrow, {
    className: "kds-ProminentLink-icon"
  }));
};
