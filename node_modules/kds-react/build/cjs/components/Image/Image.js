...
var Groceries = require('../Icon/icons/Groceries.js');
...
var ImageMissing = require('../Icon/icons/ImageMissing.js');
...
function (_Component) {
  ...
  function Image(props) {
    ...
    _this.skeletonRef = React__default.createRef();
    _this.state = {
      isLoading: true,
      isError: false,
  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      var image = React__default.createElement("img", _extends({}, props, {
      ...
      */
      ...
      var noscriptImage = React__default.createElement("noscript", null, React__default.createElement("img", _extends({}, props, {
        src: src,
        alt: alt,
      ...
      var noSrc = this.props.icon ? Icon && React__default.createElement(Icon, {
        size: "xl",
        color: "subdued"
      }) : React__default.createElement(Groceries.IconGroceries, {
        size: "xl",
        color: "subdued"
      });
      ...
      var error = React__default.createElement("div", {
        className: "bg-default-200 h-full w-full flex justify-center items-center",
        hidden: !isSsrd && isLoading
      }, src ? React__default.createElement(ImageMissing.IconImageMissing, {
        size: "xl",
        color: "subdued"
      }) : noSrc);
      var skeleton = React__default.createElement("div", {
