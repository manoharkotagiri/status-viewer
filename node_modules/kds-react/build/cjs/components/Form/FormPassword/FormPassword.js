...
var EyeSlash = require('../../Icon/icons/EyeSlash.js');
var Eye = require('../../Icon/icons/Eye.js');
...
function (_React$Component) {
  _inherits(FormPassword, _React$Component);
  ...
  function FormPassword() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      masked: true,
      id: generationUtils.generateUniqueString()
    });

    _defineProperty(_assertThisInitialized(_this), "toggleMasked", function () {
      _this.setState({
  ...
  _createClass(FormPassword, [{
    ...
    value: function render() {
      var _this$state = this.state,
          masked = _this$state.masked,
          id = _this$state.id;
      return React__default.createElement(FormField.default, _extends({
        id: id
      }, this.props, {
        type: masked ? 'password' : 'text',
        button: React__default.createElement(Button.default, {
          onClick: this.toggleMasked,
          "aria-label": masked ? 'Show Password' : 'Hide Password',
          "aria-live": "polite",
          "aria-controls": id
        }, masked ? React__default.createElement(EyeSlash.IconEyeSlash, null) : React__default.createElement(Eye.IconEye, null))
      }));
    }
  }]);
