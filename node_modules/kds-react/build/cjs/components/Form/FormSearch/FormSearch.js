...
function (_React$Component) {
  ...
  function FormSearch() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSearch", function (event) {
      ...
      functionUtils.callSafely(_this.props.onSearch)(_this.inputRef.current.value);
    });
  ...
  _createClass(FormSearch, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(FormField.default, _extends({}, props, {
        ...
        onKeyDown: functionUtils.callAll(keyboardUtils.ofEnterKey(this.handleSearch), this.props.onKeyDown),
        type: "search",
        button: React__default.createElement(Button.default, {
          onClick: this.handleSearch,
          "aria-label": "search"
        }, React__default.createElement(Search.IconSearch, null))
      }));
    }
  }]);
...
//# sourceMappingURL=FormSearch.js.map
