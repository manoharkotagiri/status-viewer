...
var Close = require('../Icon/icons/Close.js');
...
var DismissalButton = React__default.forwardRef(function (_ref, ref) {
  var kind = _ref.kind,
      className = _ref.className,
      dismissalBtnProps = _objectWithoutProperties(_ref, ["kind", "className"]);

  var kindClassName = kind !== 'default' ? "kds-DismissalButton--".concat(kind) : '';
  return React__default.createElement("button", _extends({}, dismissalBtnProps, {
    className: cx('kds-DismissalButton', "".concat(kindClassName), className),
    ref: ref
  }), React__default.createElement(Close.IconClose, {
    size: "xs"
  }));
});
...
exports.default = DismissalButton;
//# sourceMappingURL=DismissalButton.js.map
