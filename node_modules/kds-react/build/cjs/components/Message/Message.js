...
var Success = require('../Icon/icons/Success.js');
...
var Message = function Message(_ref) {
  var className = _ref.className,
      ...
      kind = _ref.kind,
      link = _ref.link,
      divProps = _objectWithoutProperties(_ref, ["className", "children", "kind", "link"]);

  var MessageIcon = kindToIconMap[kind];
  return React__default.createElement("div", _extends({
    className: cx('kds-Message', "kds-Message--".concat(kind), className)
  }, divProps), React__default.createElement(MessageIcon, {
    className: "kds-Message-icon",
    size: "utility-s"
  }), React__default.createElement(Text.default, {
    className: "kds-Message-content",
    size: "s"
  }, children, link && React__default.cloneElement(link, _objectSpread({}, link.props, {
    className: cx('kds-Message-link kds-Link kds-Link--explicit kds-Link--s', link.props.className)
  }))));
};
...
var Message$1 = React__default.memo(Message);
