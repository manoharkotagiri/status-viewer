...
var TextArea = function TextArea(_ref, ref) {
  ...
  var _React$useState = React__default.useState(value ? value.length : 0),
  ...
  return React__default.createElement(Label.LabelContext.ReverseProvider, {
  ...
  }, React__default.createElement("textarea", _extends((_extends2 = {
    ...
    'kds-TextArea--limited': hasMaxLength
  }, className)), _defineProperty(_extends2, "maxLength", maxLength), _defineProperty(_extends2, "onChange", functionUtils.callAll(handleChange, onChange)), _defineProperty(_extends2, "value", value), _defineProperty(_extends2, "ref", ref), _extends2), props)), hasMaxLength && React__default.createElement("span", {
    "aria-live": "polite",
    id: "text-area-description",
    className: "kds-Text--xs kds-TextArea-CharacterLimit"
  }, "Character Limit", ' ', isMaxLengthReached && React__default.createElement("span", {
    className: "screen-reader"
  }, "Reached"), isMaxLengthExceeded && React__default.createElement("span", {
    className: "screen-reader"
  }, "Exceeded"), ": ", count, " ", React__default.createElement("span", {
    className: "screen-reader"
...
var TextArea$1 = React.memo(React.forwardRef(TextArea));
