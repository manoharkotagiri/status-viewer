...
var Ellipsis = require('../Icon/icons/Ellipsis.js');
...
var _paginationFunctions = require('./_paginationFunctions.js');
...
var PaginationComponent = function PaginationComponent(_ref) {
  ...
  var pagination = React.useRef();
  var prevButton = React.useRef();
  var nextButton = React.useRef();
  var pageLinks = _paginationFunctions.normalizePageLinks(_paginationFunctions.generateVisiblePageLinks(numberOfPages, numberOfDisplayedPages, currentPage));
  useOnResize.default({
    onResize: setLinks,
  ...
  function changePage(page, e) {
    functionUtils.callSafely(onPageChange)(page, e);
    setPage(page);
  }

  function navigateToPage(page, e) {
    var _getWindow = windowUtils.getWindow(),
        location = _getWindow.location;

    var href = functionUtils.callSafely(hrefBuilder)(page);
  ...
  function setLinks() {
    if (pagination.current) {
      ...
      var numberOflinks = _paginationFunctions.getNumberOfDisplayedPageLinks(numberOfPages, containerWidth, buttonWidth);
  ...
  return React__default.createElement("nav", _extends({
  ...
  }, props), React__default.createElement(Button.default, {
    ref: prevButton,
    ...
    onClick: function onClick(e) {
      ...
      _paginationFunctions.captureFocusAfterDisablingButton(prevButton);
    }
  }, React__default.createElement(CaretLeft.IconCaretLeft, null)), pageLinks.reduce(function (acc, page, i) {
    ...
    return [].concat(_toConsumableArray(acc), [React__default.createElement(Link.default, {
      key: page,
      ...
      href: functionUtils.callSafely(hrefBuilder)(page),
      withRouter: withRouter,
      implied: true
    }, page), appendEllipsis && React__default.createElement(Ellipsis.IconEllipsis, {
    ...
    onClick: function onClick(e) {
      ...
      _paginationFunctions.captureFocusAfterDisablingButton(nextButton);
    }
  }, React__default.createElement(CaretRight.IconCaretRight, null)));
};

var Pagination = function Pagination(props) {
  if (props.withRouter) {
    var PaginationWithRouter = reactRouterDom.withRouter(PaginationComponent);
    return React__default.createElement(PaginationWithRouter, props);
  } else {
    return React__default.createElement(PaginationComponent, props);
  }
};
