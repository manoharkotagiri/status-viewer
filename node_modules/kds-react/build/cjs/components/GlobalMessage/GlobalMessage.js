...
var _Error = require('../Icon/icons/Error.js');
...
var Warning = require('../Icon/icons/Warning.js');
...
var globalMessageKinds = ['info', 'error', 'warning'];
var kindToIconMap = {
  info: Info.IconInfo,
  error: _Error.IconError,
...
/*#__PURE__*/
function (_Component) {
  _inherits(GlobalMessage, _Component);
  ...
  _createClass(GlobalMessage, [{
    key: "getTextFromChildren",
    value: function getTextFromChildren(children) {
      var _this2 = this;

      var text = ''; // Recursively get text from children. Think of it as `children.innerText`.

      React__default.Children.map(children, function (child) {
        if (typeof child === 'string') {
          text += child;
        } else if (child.props && child.props.children) {
          text += ' ' + _this2.getTextFromChildren(child.props.children);
        }
      });
      return text;
    }
    ...
    value: function render() {
      ...
      var GlobalMessageIcon = kindToIconMap[kind];
      var isErrorLike = kind === 'error' || kind === 'warning';
      return show ? React__default.createElement("div", {
        className: cx('kds-GlobalMessage', "kds-GlobalMessage--".concat(kind), 'border-b', 'border-solid', className),
        "aria-label": "".concat(kind, " message: ").concat(heading, " ").concat(this.getTextFromChildren(children)),
        role: isErrorLike ? 'alertdialog' : 'dialog'
      }, React__default.createElement(GlobalMessageIcon, {
        size: "utility-l",
        className: "kds-GlobalMessage-icon"
      }), heading && React__default.createElement(Heading.default, {
        className: "kds-GlobalMessage-heading max-w-full",
        bold: true,
        size: "s"
      }, heading), React__default.createElement(Paragraph.default, {
        className: "kds-GlobalMessage-body max-w-full mb-0",
        size: "m"
      }, children), onClose && React__default.createElement(DismissalButton.default, {
        kind: kind,
...
_defineProperty(GlobalMessage, "kinds", globalMessageKinds);

_defineProperty(GlobalMessage, "defaultProps", {
  kind: 'info'
});

exports.default = GlobalMessage;
exports.globalMessageKinds = globalMessageKinds;
