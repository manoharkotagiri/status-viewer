...
var _ToastContext = require('./_ToastContext.js');
var _Portal = require('../Portal/_Portal.js');
...
function (_Component) {
  ...
  function ToastProvider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "add", function (content) {
      var id = generationUtils.generateUniqueString();
  ...
  _createClass(ToastProvider, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(_ToastContext.Provider, {
        value: add
      }, this.props.children, windowUtils.canUseDOM() ? React__default.createElement(_Portal.default, {
        id: "toast"
        ...
        }, React__default.createElement(Toast.default, {
          kind: content.kind,
