...
var getKind = function getKind(kind) {
  var legacyKindMap = {
    success: 'positive',
    error: 'negative',
    warning: 'callout',
...
var ToastIcon = function ToastIcon(_ref) {
  var kind = _ref.kind;
  var Glyph = toasts[kind];
  return React__default.createElement(Glyph, {
    size: "utility-l",
    className: "kds-Toast-icon"
  });
};
/**
...
var Toast = function Toast(_ref2) {
  ...
  return React__default.createElement("section", {
    role: "alert",
    "aria-live": "assertive",
    className: cx('kds-Toast', "kds-Toast--".concat(kind), className)
  }, React__default.createElement("header", {
    className: "kds-Toast-header"
  }, React__default.createElement(ToastIcon, {
    kind: kind
  }), React__default.createElement(Heading.default, {
    tag: "h1",
    className: "kds-Toast-heading",
    size: "s"
  }, heading)), React__default.createElement(Paragraph.default, {
    className: "kds-Toast-body",
    size: "m"
  }, children), React__default.createElement(DismissalButton.default, {
    kind: getKind(kind),
