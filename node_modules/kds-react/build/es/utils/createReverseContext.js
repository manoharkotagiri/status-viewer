...
function createReverseContext(defaultValue) {
  var NativeContext = React.createContext();
  ...
  function (_React$Component) {
    ...
    _createClass(ReverseProvider, [{
      ...
      value: function render() {
        ...
        return React.createElement(NativeContext.Consumer, null, function (setState) {
  ...
  function (_React$Component2) {
    ...
    _createClass(ReverseConsumer, [{
      key: "render",
      value: function render() {
        return React.createElement(NativeContext.Provider, {
