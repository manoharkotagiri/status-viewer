...
function (_PureComponent) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "uniqueId", _this.props.id || "kds-Modal-".concat(generateUniqueString()));
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var heading = React.createElement(React.Fragment, null, HeaderIcon && React.createElement(HeaderIcon, {
        size: "utility-l",
      ...
      }, props), allowClose && React.createElement(DismissalButton, {
        className: "kds-Modal-closeButton",
        "aria-label": "Close pop-up",
        onClick: callSafely(handleCloseModal)
      }), React.createElement("header", {
        className: "kds-Modal-header"
      }, isOnboarding ? React.createElement("div", {
        className: "kds-Modal-headerImage"
      }, onboardingHeaderImage) : heading), React.createElement("div", {
        className: "kds-Modal-body"
      }, React.createElement("div", {
        className: "kds-Modal-content"
      }, isOnboarding && heading, children)), showProgressIndicator && React.createElement(Text, {
        size: "l",
        className: "kds-Modal-progressIndicator"
      }, "".concat(onboardingStepCurrent, " of ").concat(onboardingStepTotal)), showFooter && (PrimaryActionButton || SecondaryActionButton) && React.createElement("footer", {
