...
import { sizes as propOpts_2, colors as propOpts_3, inlineSizeMap as propOpts_1 } from './propOpts.js';
...
function (_React$Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function componentDidMount() {
      ...
      var trySettingAutoFontSize = function trySettingAutoFontSize(el) {
        ...
        if (el && getWindow()) {
          ...
          var computedStyle = getWindow().getComputedStyle(el);
          ...
          var autoFontSizeClass = propOpts_1[computedFontSizeNum.toFixed(1) // .toFixed(1) to match inlineSizeMap keys
          ];
    ...
    value: function render() {
      ...
      var fontSizeClass = propOpts_2[size] || autoFontSizeClass;
      var classes = cx('kds-Icon',
      /** Apply inline class if size prop is unset or invalid value. */
      {
        'kds-Icon--inline': typeof size === 'undefined' || !propOpts_2[size]
      }, propOpts_3[color], fontSizeClass, className);
      ...
      }, props), children, title ? React.createElement("title", null, title) : null);
    }
  }]);
