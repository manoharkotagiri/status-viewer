...
import { wrappingModulus } from '../../utils/numberUtils.js';
...
function (_Component) {
  ...
  function Tabs() {
    ...
    _defineProperty(_assertThisInitialized(_this), "uniqueId", generateUniqueString());
    ...
    _defineProperty(_assertThisInitialized(_this), "selectTab", function (index) {
      ...
      var newIndex = wrappingModulus(index, _this.props.tabs.length);
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement("div", {
        ...
        return content && _this2.state.loadedTabs[index] ? React.createElement("section", {
