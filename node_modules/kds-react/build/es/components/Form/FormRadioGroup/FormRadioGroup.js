...
var RADIO_REQUIRED_DEFAULT_TEXT = 'A selection is required.';
/**
...
var FormRadioGroup = function FormRadioGroup(_ref) {
  var required = _ref.required,
      ...
      props = _objectWithoutProperties(_ref, ["required", "validations"]);

  return React.createElement(FormField, _extends({}, props, {
    as: RadioGroup,
    validations: required ? addRequiredToValidations(validations, RADIO_REQUIRED_DEFAULT_TEXT) : validations
  }));
};

export default FormRadioGroup;
export { RADIO_REQUIRED_DEFAULT_TEXT };
