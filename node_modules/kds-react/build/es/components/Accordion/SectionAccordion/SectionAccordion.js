...
function (_PureComponent) {
  ...
  function SectionAccordion() {
    ...
    _defineProperty(_assertThisInitialized(_this), "uniqueId", _this.props.id || "kds-SectionAccordion-".concat(generateUniqueString()));
  ...
  _createClass(SectionAccordion, [{
    ...
    value: function render() {
      ...
      }, renderTitle(title), React.createElement(IconCaretRight, {
        size: "s",
