...
import { IconDownload } from '../Icon/icons/Download.js';
...
import { IconExternal } from '../Icon/icons/External.js';
...
import { isKDSIcon } from '../../utils/iconUtils.js';
...
var Link = function Link(_ref) {
  ...
  if (typeof noRouter !== 'undefined') {
    deprecationWarning("'noRouter' prop in kds-react Link is deprecated and will soon be removed. No action is required http://design.kroger.com/#/react/components/link");
  }

  if (!noRouter && typeof withRouter === 'undefined') {
    deprecationWarning("kds-react Link default behavior is changing to render an 'a' tag by default. Use 'withRouter' prop to continue rendering a react-router NavLink http://design.kroger.com/#/react/components/link");
  }
  ...
  var renderChildren = function renderChildren() {
    return React.Children.map(children, function (child) {
      return isKDSIcon(child) ? React.cloneElement(child, {
        className: cx(child.props.className, iconSizeClass)
      }) : child;
    });
  };

  return React.createElement(Tag, _extends({}, newProps, {
    className: classes
  }), renderChildren(), isExternal && React.createElement(IconExternal, {
    className: iconSizeClass
  }), isDownload && React.createElement(IconDownload, {
    className: iconSizeClass
  }));
};
