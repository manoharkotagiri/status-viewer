...
function (_PureComponent) {
  ...
  function Stepper() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      clampedMax: clamp(_this.props.max, 1, 999),
    ...
    _defineProperty(_assertThisInitialized(_this), "debouncedOnChange", debounce(function (value) {
  ...
  _createClass(Stepper, [{
    ...
    value: function render() {
      ...
      }), callToAction && React.createElement(Button, {
      ...
      }, callToAction), React.createElement("div", {
      ...
      }, destructiveDecrement ? React.createElement(IconTrash, null) : React.createElement(IconMinus, null)), React.createElement("div", {
