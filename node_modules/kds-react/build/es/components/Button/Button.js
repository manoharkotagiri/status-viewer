...
function getTruthyChildrenAsArray(children) {
  return Children.toArray(children).filter(function (v) {
...
var Button = function Button(_ref, ref) {
  ...
  return React.createElement("button", _extends({
    ...
    className: classes
  }), renderChildren(), indeterminate && React.createElement(LoadingSpinner, {
    size: "xs",
...
var ButtonWithForwardRef = React.forwardRef(Button);
