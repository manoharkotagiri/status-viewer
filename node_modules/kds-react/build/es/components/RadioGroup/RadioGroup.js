...
var RadioGroup = function RadioGroup(_ref, ref) {
  ...
  var computedName = useMemo(function () {
    return name || "".concat(generateUniqueString(), "-radioGroup");
  }, [name]);
  return (
    /*
    ...
    React.createElement("div", _extends({
      ...
      var computedValue = isTruthyOrZero(value) ? value : radioLabel;
...
var RadioGroupWithForwardRef = React.forwardRef(RadioGroup);
