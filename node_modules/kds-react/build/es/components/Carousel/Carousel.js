...
import { IconSkipToEnd } from '../Icon/icons/SkipToEnd.js';
import { IconSkipToStart } from '../Icon/icons/SkipToStart.js';
...
import { getCarouselWidth, getTemplateWidth, getIsAtStartOfCarousel, getIsAtEndOfCarousel, useCarouselOnScrollCallback, useCarouselOnNextButtonClickCallback, useCarouselOnPreviousButtonClickCallback, useOnSkipToStartButtonClickCallback, useOnSkipToEndButtonClickCallback, CAROUSEL_GUTTER_WIDTH, getFullContainerWidth, getStartIndexToRender, getEndIndexToRender, getNumberOfSections, getCurrentSection, getNumberOfItemsShown } from './_carouselFunctions.js';
import { PaginationDots } from './_PaginationDots.js';
...
var Carousel = function Carousel(_ref) {
  ...
  var templateWidth = getTemplateWidth(carousel);
  var templateWithGutterWidth = templateWidth + CAROUSEL_GUTTER_WIDTH;
  var totalNumberOfItems = data.length;
  var numberOfItemsShown = getNumberOfItemsShown(carouselWidth, templateWithGutterWidth);
  var containerWidth = getFullContainerWidth(templateWithGutterWidth, totalNumberOfItems);
  var isAtStartOfCarousel = getIsAtStartOfCarousel(carousel);
  var isAtEndOfCarousel = getIsAtEndOfCarousel(carousel, containerWidth);
  var onScroll = useCarouselOnScrollCallback({
    carousel: carousel,
  ...
  var onNextButtonClick = useCarouselOnNextButtonClickCallback({
    carousel: carousel,
    templateWithGutterWidth: templateWithGutterWidth,
    templateWidth: templateWidth,
    numberOfItemsShown: numberOfItemsShown
  });
  var onPreviousButtonClick = useCarouselOnPreviousButtonClickCallback({
    carousel: carousel,
    containerWidth: containerWidth,
    templateWithGutterWidth: templateWithGutterWidth,
    numberOfItemsShown: numberOfItemsShown
  });
  var onSkipToStartButtonClick = useOnSkipToStartButtonClickCallback({
    carousel: carousel
  });
  var onSkipToEndButtonClick = useOnSkipToEndButtonClickCallback({
    carousel: carousel,
    templateWithGutterWidth: templateWithGutterWidth,
    totalNumberOfItems: totalNumberOfItems,
    containerWidth: containerWidth
  });
  var startOfData = getStartIndexToRender(firstFullyVisibleElementIndex, numberOfItemsShown);
  var endOfData = getEndIndexToRender(totalNumberOfItems, firstFullyVisibleElementIndex, numberOfItemsShown);
  var dataToRender = data.slice(startOfData, endOfData);
  var numberOfSections = getNumberOfSections(carouselWidth, totalNumberOfItems, numberOfItemsShown);
  var currentSection = getCurrentSection(firstFullyVisibleElementIndex, numberOfItemsShown, numberOfSections, isAtEndOfCarousel, totalNumberOfItems);
  return React.createElement("div", {
  ...
  }, React.createElement(IconCaretLeft, null)), React.createElement("div", {
    ...
    }, React.createElement(Template, _extends({}, propsForTemplate, {
      key: itemKey
    ...
    }, React.createElement(IconSkipToStart, null)), React.createElement(Button, {
      compact: true,
      "aria-label": "Skip to last item of carousel",
      className: "kds-Carousel-button--skip",
      kind: "secondary",
      onClick: onSkipToEndButtonClick
    }, React.createElement(IconSkipToEnd, null))));
  }))))), React.createElement(Button, {
  ...
  }, React.createElement(IconCaretRight, null))), React.createElement(PaginationDots, {
