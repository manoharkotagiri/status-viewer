import { r as registerInstance, h, H as Host, g as getElement } from './index-7f5ea1ce.js';
...
const KdsButtonGroup = class {
  constructor(hostRef) {
    ...
    this.groupName = generateUniqueString();
  }
  render() {
    return (h(Host, { class: {
...
const KdsButtonGroupMember = class {
  ...
  renderIcon(iconOnly) {
    ...
    if (isTruthyOrZero(this.badgeValue)) {
      return (h("kds-badge", { class: {
        ...
        }, count: this.badgeValue }, h(Icon, { size: "m" })));
    }
    else {
  ...
  render() {
    ...
    const TypeJSX = () => (h(Type, { type: this.buttonGroup.groupType !== "button" && this.buttonGroup.groupType, id: this.buttonGroup.groupType !== "button" &&
      ...
      } }, this.buttonGroup.groupType === "button" && (h(Fragment, null, this.icon &&
      this.iconPlacement === "left" &&
      this.renderIcon(iconOnly), this.renderText(iconOnly), h("slot", null), this.icon &&
    ...
    const LabelJSX = () => (h("label", { htmlFor: `kds-ButtonGroup-input-${this.uniqueId}`, class: {
      ...
      this.iconPlacement === "right" &&
      this.renderIcon(iconOnly)));
    return (h(Host, { class: "kds-ButtonGroup-member-wrapper", style: this.disabled && { "pointer-events": "none" } }, this.buttonGroup.groupType === "button" &&
      (this.tooltip ? (h("kds-tooltippable", { side: this.tooltipSide, align: this.tooltipAlign, tooltipText: this.tooltipText, tooltipType: this.tooltipType }, h(TypeJSX, null), h("slot", { name: "tooltipText" }))) : (h(TypeJSX, null))), this.buttonGroup.groupType !== "button" && (h(Fragment, null, h(TypeJSX, null), this.tooltip ? (h("kds-tooltippable", { side: this.tooltipSide, align: this.tooltipAlign, tooltipText: this.tooltipText, tooltipType: this.tooltipType }, h(LabelJSX, null), h("slot", { name: "tooltipText" }))) : (h(LabelJSX, null))))));
  }
  get hostEl() { return getElement(this); }
...
export { KdsButtonGroup as kds_buttongroup, KdsButtonGroupMember as kds_buttongroup_member };
