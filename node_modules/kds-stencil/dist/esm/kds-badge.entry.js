import { r as registerInstance, h, g as getElement } from './index-7f5ea1ce.js';
...
const KdsBadge = class {
  ...
  render() {
    ...
    return (h("output", { class: "kds-Badge-wrapper", ref: (el) => {
      ...
      } }, h("slot", null), this.count !== undefined && (h("svg", { class: {
        "kds-Badge": true,
      ...
      } }, h("rect", { width: "100%", height: "100%", ry: characterCount === 1 ? "100%" : "50%" }), h("text", { x: "50%", y: "75%", "text-anchor": "middle", fill: "currentColor" }, this.count)))));
  }
  get hostEl() { return getElement(this); }
};
KdsBadge.style = kdsBadgeCss;

export { KdsBadge as kds_badge };
