...
const KdsImage = class {
  ...
  render() {
    ...
    return (h(Host, { class: "kds-Image", "aria-busy": !!isLoading }, isError ? error : image, isLoading && skeleton));
  }
...
KdsImage.style = kdsImageCss;

export { KdsImage as kds_image };
