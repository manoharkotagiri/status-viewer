...
const KdsTag = class {
  ...
  render() {
    ...
    return (h(Host, { class: {
      ...
      }, role: "note", "aria-label": `Tag: ${this.ariaMessage}` }, Icon && h(Icon, { class: "kds-Tag-Icon mr-4", size: "s" }), h("span", { class: "kds-Tag-text" }, text, h("slot", null)), !this.compact && isActionKind && (h("button", { "aria-label": "Select to remove tag", onClick: this.onRemoveTagClick, class: `kds-DismissalButton kds-DismissalButton--neutral kds-Tag-dismissalButton ml-4` }, h("kds-icon-close", { size: "xs" })))));
  }
  get hostEl() { return getElement(this); }
};
KdsTag.style = kdsTagCss;

export { KdsTag as kds_tag };
