...
const KdsTextArea = class {
  ...
  render() {
    return (h(Host, { class: "kds-TextArea-wrapper" }, h("textarea", { class: {
        "kds-TextArea": true,
        "kds-TextArea--limited": Boolean(this.maxlength)
      }, "aria-describedby": "text-area-description", "aria-invalid": this.ariaInvalid, disabled: this.disabled, form: this.form, maxlength: this.maxlength, minlength: this.minlength, name: this.name, onInput: event => this.onInput(event), onKeyUp: () => this.checkLength(), onBlur: () => (this.renderMaxLengthMessage = false), placeholder: this.placeholder, readonly: this.readonly, required: this.required, value: this.value, ref: (el) => (this.nativeElement = el) }), this.maxlength && (h(Fragment, null, h("span", { "aria-live": "polite", id: "text-area-description", "test-id": Build.isDev , class: "kds-Text--xs kds-TextArea-CharacterLimit", "aria-hidden": "true" }, "Character Limit: ", this.count, " ", h("span", { class: "screen-reader" }, "of"), h("span", { "aria-hidden": "true" }, "/"), " ", this.maxlength)))));
  }
  get hostEl() { return getElement(this); }
  static get watchers() { return {
    "maxlength": ["removeInlineStyle"]
  }; }
};
KdsTextArea.style = kdsTextareaCss;

export { KdsTextArea as kds_textarea };
