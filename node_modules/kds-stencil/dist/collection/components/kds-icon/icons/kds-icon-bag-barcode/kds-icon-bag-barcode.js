...
export class KdsIconBagBarcode {
  render() {
    const paths = (h(Fragment, null,
      h("path", { d: "M6.728 3.792a1.061 1.061 0 0 0 .274-1.024 1.062 1.062 0 0 0-1.294 1.301 1.055 1.055 0 0 0 1.02-.277z" }),
      ...
      h("path", { d: "M9.764 10.415a.375.375 0 0 0-.375.375v1.448a.375.375 0 0 0 .75 0V10.79a.375.375 0 0 0-.375-.375z" }),
      h("path", { d: "M7.883 10.415a.375.375 0 0 0-.375.375v2.325a.375.375 0 0 0 .75 0V10.79a.375.375 0 0 0-.375-.375z" }),
      h("path", { d: "M11.641 10.415a.375.375 0 0 0-.375.375v2.325a.375.375 0 0 0 .75 0V10.79a.375.375 0 0 0-.375-.375z" }),
      h("path", { d: "M12.59 8.897H6.94a1.127 1.127 0 0 0-1.126 1.125v3.886a1.127 1.127 0 0 0 1.125 1.125h5.65a1.127 1.127 0 0 0 1.125-1.125v-3.886a1.127 1.127 0 0 0-1.125-1.125zm.374 5.011a.375.375 0 0 1-.375.375H6.94a.375.375 0 0 1-.375-.375v-3.886a.375.375 0 0 1 .375-.375h5.65a.375.375 0 0 1 .375.375z" })));
    return (h("kds-icon", { size: this.size, color: this.color, paths: paths }));
  }
  static get is() { return "kds-icon-bag-barcode"; }
