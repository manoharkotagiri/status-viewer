...
export class KdsIconDeliBakery {
  render() {
    const paths = (h(Fragment, null,
      h("path", { d: "M5.713 14.688a3.287 3.287 0 0 1-3.06-2.088.375.375 0 0 1 .513-.474 2.454 2.454 0 0 0 2.797-.476 1.467 1.467 0 0 1 2.074 2.076 3.267 3.267 0 0 1-2.324.962zm-1.891-1.595c.031.034.063.068.097.101a2.596 2.596 0 0 0 3.587 0 .716.716 0 1 0-1.013-1.012 3.22 3.22 0 0 1-2.671.91z" }),
      h("path", { d: "M10.47 14.688a3.261 3.261 0 0 1-2.323-.962 1.466 1.466 0 0 1 0-2.076 1.473 1.473 0 0 1 2.073 0 2.452 2.452 0 0 0 2.796.476.375.375 0 0 1 .513.474 3.28 3.28 0 0 1-3.059 2.088zm-1.287-2.716a.716.716 0 0 0-.506 1.222v.001a2.596 2.596 0 0 0 3.586 0c.035-.034.067-.068.098-.102a3.222 3.222 0 0 1-2.67-.911.715.715 0 0 0-.508-.21z" }),
  ...
  static get is() { return "kds-icon-deli-bakery"; }
