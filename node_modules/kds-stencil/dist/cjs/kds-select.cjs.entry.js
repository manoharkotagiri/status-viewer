...
const KdsSelect = class {
  ...
  componentWillLoad() {
    ...
    this.slotObserver = registerObserver.registerSlotObserver(this, (mutations) => {
  ...
  componentDidLoad() {
    ...
    this.selectElement.selectedIndex = objectUtils.isTruthyOrZero(this.selectedIndex)
      ? this.selectedIndex
  ...
  render() {
    return (index.h("select", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { autoFocus: this.autofocus, disabled: this.disabled, form: this.form, name: this.name, required: this.required, class: {
        "kds-Select": true,
        "kds-Select--compact": this.compact,
        [this.innerAttrs.class]: this.innerAttrs.class
      }, ref: (el) => this.createSelectElementRef(el), onInput: this.onInput }), index.h("slot", null)));
  }
