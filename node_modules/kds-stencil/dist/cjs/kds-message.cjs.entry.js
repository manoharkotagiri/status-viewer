...
const KdsMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h(MessageIcon, { class: "kds-Message-icon", size: "utility-s" }), index.h("kds-text", { class: "kds-Message-content", size: "s" }, index.h("slot", null)), closable && (index.h("button", { "aria-label": "Close alert", "data-testid": "kds-Message-closeButton", onClick: onCloseButtonClick, class: {
...
KdsMessage.style = kdsMessageCss;

exports.kds_message = KdsMessage;
