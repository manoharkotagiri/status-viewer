...
const KdsTag = class {
  constructor(hostRef) {
    ...
    this.tagRemoved = index.createEvent(this, "tagRemoved", 7);
    /**
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      }, role: "note", "aria-label": `Tag: ${this.ariaMessage}` }, Icon && index.h(Icon, { class: "kds-Tag-Icon mr-4", size: "s" }), index.h("span", { class: "kds-Tag-text" }, text, index.h("slot", null)), !this.compact && isActionKind && (index.h("button", { "aria-label": "Select to remove tag", onClick: this.onRemoveTagClick, class: `kds-DismissalButton kds-DismissalButton--neutral kds-Tag-dismissalButton ml-4` }, index.h("kds-icon-close", { size: "xs" })))));
  }
  get hostEl() { return index.getElement(this); }
};
KdsTag.style = kdsTagCss;

exports.kds_tag = KdsTag;
