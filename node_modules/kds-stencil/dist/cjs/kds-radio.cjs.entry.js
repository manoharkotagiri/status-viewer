...
const KdsRadio = class {
  ...
  render() {
    return (index.h("input", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { autofocus: this.autofocus, checked: this.checked, disabled: this.disabled, name: this.name, required: this.required, class: {
        "kds-RadioButton": true,
        [this.innerAttrs.class]: this.innerAttrs.class,
        "kds-RadioButton--compact": this.compact
      }, type: "radio", value: this.value, onChange: this.onChange, ref: (el) => {
...
KdsRadio.style = kdsRadioCss;

exports.kds_radio = KdsRadio;
