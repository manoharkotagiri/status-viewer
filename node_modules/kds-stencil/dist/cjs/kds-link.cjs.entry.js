...
const KdsLink = class {
  ...
  render() {
    ...
    return (index.h("a", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { href: this.href, hrefLang: this.hreflang, class: classes, download: this.download, rel: this.rel, target: this.target, ref: (el) => {
        this.nativeElement = el;
        attributeUtils.setStyleAttribute(el, this.innerAttrs);
      } }), index.h("slot", null), isExternal && index.h("kds-icon-external", null), isDownload && index.h("kds-icon-download", null)));
  }
...
KdsLink.style = kdsLinkCss;

exports.kds_link = KdsLink;
