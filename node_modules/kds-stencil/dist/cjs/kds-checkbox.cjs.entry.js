...
const KdsCheckBox = class {
  ...
  render() {
    return (index.h("input", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { autofocus: this.autofocus, checked: this.checked, disabled: this.disabled, indeterminate: this.indeterminate, name: this.name, required: this.required, onChange: this.onChange, class: {
        "kds-Checkbox": true,
...
KdsCheckBox.style = kdsCheckboxCss;

exports.kds_checkbox = KdsCheckBox;
