...
const KdsBadge = class {
  ...
  render() {
    ...
    return (index.h("output", { class: "kds-Badge-wrapper", ref: (el) => {
        this.outputElement = el;
      } }, index.h("slot", null), this.count !== undefined && (index.h("svg", { class: {
        "kds-Badge": true,
      ...
      } }, index.h("rect", { width: "100%", height: "100%", ry: characterCount === 1 ? "100%" : "50%" }), index.h("text", { x: "50%", y: "75%", "text-anchor": "middle", fill: "currentColor" }, this.count)))));
  }
  get hostEl() { return index.getElement(this); }
};
KdsBadge.style = kdsBadgeCss;

exports.kds_badge = KdsBadge;
