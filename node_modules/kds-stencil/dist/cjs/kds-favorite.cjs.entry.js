...
const KdsFavorite = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("button", { "aria-label": `${favorited ? "Remove" : "Save"} ${what} ${favorited ? "from" : "to"} my favorites.`, "aria-pressed": `${Boolean(favorited)}`, ref: el => (this.buttonRef = el), onClick: () => this.buttonRef.setAttribute("aria-pressed", `${!Boolean(favorited)}`), class: {
        "kds-Favorite": true,
        "kds-Favorite--favorited": favorited,
        [buttonClass]: Boolean(buttonClass)
      }, disabled: disabled }, index.h(IconFavorited, { hidden: !favorited, color: "interactive" }), index.h(Icon, { hidden: favorited }))));
  }
};
KdsFavorite.style = favoriteCss;

exports.kds_favorite = KdsFavorite;
