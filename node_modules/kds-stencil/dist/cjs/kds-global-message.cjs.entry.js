...
const KdsGlobalMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      }, role: kindToRoleMap[kind], "aria-label": `${kind} message: ${heading ? heading : ""} ${this.ariaMessage.trim()}` }, index.h(GlobalMessageIcon, { size: "l", class: "kds-GlobalMessage-icon" }), heading && (index.h("h3", { class: `kds-GlobalMessage-heading kds-Heading kds-Heading--s max-w-full` }, heading)), index.h("p", { class: "kds-GlobalMessage-body kds-Paragraph kds-Paragraph--m max-w-full mb-0" }, message, index.h("slot", null)), links.length > 0 && (index.h("div", { class: "flex flex-col sm:flex-row sm:flex-wrap mt-8 kds-Paragraph--m line-length" }, index.h("slot", { name: "link" }))), closable && (index.h("button", { "aria-label": "Close alert", "data-testid": "kds-GlobalMessage-closeButton", onClick: onCloseButtonClick, class: {
...
KdsGlobalMessage.style = kdsGlobalMessageCss;

exports.kds_global_message = KdsGlobalMessage;
