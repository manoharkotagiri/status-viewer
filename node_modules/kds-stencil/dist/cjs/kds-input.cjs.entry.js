...
const KdsInput = class {
  ...
  render() {
    return (index.h("input", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { autocomplete: this.autocomplete, autofocus: this.autofocus, disabled: this.disabled, form: this.form, list: this.list, inputMode: this.inputmode, maxlength: this.maxlength, minlength: this.minlength, name: this.name, pattern: this.pattern, placeholder: this.placeholder, readonly: this.readonly, required: this.required, type: this.type, class: {
        "kds-Input": true,
...
KdsInput.style = kdsInputCss;

exports.kds_input = KdsInput;
