...
const KdsLabel = class {
  ...
  render() {
    ...
    return (index.h("label", Object.assign({}, attributeUtils.getSpreadableAttributes(this.innerAttrs), { htmlFor: this.for, form: this.form, class: {
...
KdsLabel.style = kdsLabelCss;

exports.kds_label = KdsLabel;
