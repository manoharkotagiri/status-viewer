...
const KdsTextArea = class {
  ...
  render() {
    return (index.h(index.Host, { class: "kds-TextArea-wrapper" }, index.h("textarea", { class: {
        "kds-TextArea": true,
        "kds-TextArea--limited": Boolean(this.maxlength)
      }, "aria-describedby": "text-area-description", "aria-invalid": this.ariaInvalid, disabled: this.disabled, form: this.form, maxlength: this.maxlength, minlength: this.minlength, name: this.name, onInput: event => this.onInput(event), onKeyUp: () => this.checkLength(), onBlur: () => (this.renderMaxLengthMessage = false), placeholder: this.placeholder, readonly: this.readonly, required: this.required, value: this.value, ref: (el) => (this.nativeElement = el) }), this.maxlength && (index.h(fragment.Fragment, null, index.h("span", { "aria-live": "polite", id: "text-area-description", "test-id": index.Build.isDev , class: "kds-Text--xs kds-TextArea-CharacterLimit", "aria-hidden": "true" }, "Character Limit: ", this.count, " ", index.h("span", { class: "screen-reader" }, "of"), index.h("span", { "aria-hidden": "true" }, "/"), " ", this.maxlength)))));
  }
...
exports.kds_textarea = KdsTextArea;
