...
const KdsIcon = class {
  constructor(hostRef) {
    ...
    this.trySettingAutoFontSize = (el) => {
      ...
      if (el && windowUtils.getWindow()) {
        ...
        const computedStyle = windowUtils.getWindow().getComputedStyle(this.hostEl);
  ...
  render() {
    ...
    return (index.h("svg", { class: classes, focusable: "false", fill: "currentColor", ref: (el) => this.setSize(el), width: "1em", height: "1em", viewBox: "0 0 16 16" }, this.paths));
  }
  get hostEl() { return index.getElement(this); }
};
KdsIcon.style = iconCss;

exports.kds_icon = KdsIcon;
