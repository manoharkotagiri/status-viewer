...
const windowUtils = require('./windowUtils-94895160.js');
...
const ToastIcon = ({ kind }) => {
  ...
  return index.h(Glyph, { size: "utility-l", class: "kds-Toast-icon" });
};
const KdsToast = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    return (index.h("section", { role: "alert", "aria-live": "assertive", class: {
        "kds-Toast": true,
        [`kds-Toast--${this.kind}`]: true
      } }, index.h("header", { class: "kds-Toast-header" }, index.h(ToastIcon, { kind: kind }), index.h("h1", { class: "kds-Toast-heading" }, heading)), index.h("p", { class: "kds-Toast-body" }, index.h("slot", null), this.message), index.h("button", { onClick: () => this.handleClose(), class: {
...
KdsToastController.style = kdsToastControllerCss;

exports.kds_toast = KdsToast;
exports.kds_toast_controller = KdsToastController;
